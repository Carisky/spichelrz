...
class ControllerExtensionModuleOCFilter extends Controller {
  use Helper;
    ...
    $this->document->addScript('catalog/view/javascript/ocfilter/nouislider.min.js', 'footer'); //
    $this->document->addScript('catalog/view/javascript/ocfilter/ocfilter.js', 'footer'); //
  ...
  public function callback() {
	...
	public function nrGetSelection()  //
	{
		if ($this->config->get('module_ocfilter_show_selected') and $this->ocfilter->getOptionsGet()) {
			$data['selecteds'] = $this->ocfilter->getSelectedOptions();
		} else {
			$data['selecteds'] = array();
		}
		...
		return $this->load->view('extension/module/ocfilter/selected_filter', $data);
