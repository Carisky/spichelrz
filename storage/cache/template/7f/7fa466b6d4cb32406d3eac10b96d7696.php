...
class __TwigTemplate_d06daed99b2442f19df5ef18fce3398d extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
                // line 150
                if (twig_get_attribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 150)) {
                    // line 151
...
\t\t\t\t\t";
                    ...
                    echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "href", [], "any", false, false, false, 153);
                    echo "\">";
                    echo twig_get_attribute($this->env, $this->source, $context["breadcrumb"], "text", [], "any", false, false, false, 153);
                    echo "</a>
\t\t\t\t\t\t<span>/</span>
\t\t\t\t\t";
                }
...
\t\t\t</div>
      <form action=\"";
        // line 166
        echo ($context["action"] ?? null);
        echo "\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal contact-form\">
\t\t\t\t<div class=\"form-row\">
\t\t\t\t\t<input type=\"text\" name=\"name\" value=\"";
        // line 168
        echo ($context["name"] ?? null);
        echo "\" id=\"input-name\" placeholder=\"Imię\" class=\"form-control\" required/>
              ";
        // line 169
        if (($context["error_name"] ?? null)) {
            // line 170
...
\t\t\t\t\t<input type=\"text\" name=\"email\" value=\"";
        // line 174
        echo ($context["email"] ?? null);
        echo "\" id=\"input-email\" placeholder=\"Email\" class=\"form-control\" />
              ";
        // line 175
        if (($context["error_email"] ?? null)) {
            // line 176
        ...
        echo "\t\t\t\t</div>
\t\t\t\t<div class=\"form-row\">
          <textarea name=\"enquiry\" rows=\"4\" id=\"input-enquiry\" placeholder=\"Wiadomość\" class=\"form-control\">";
        // line 180
        echo ($context["enquiry"] ?? null);
        echo "</textarea>
              ";
...
\t\t<div class=\"right\">
            <div class=\"data-list\">
                ...
                <div class=\"data-row\"><span>Adres:</span> Poland, woj. Małopolskie, Kraków, ul. Wrobela 5</div>
