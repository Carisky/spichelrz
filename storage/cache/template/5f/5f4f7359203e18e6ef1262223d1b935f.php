...
class __TwigTemplate_1a6db8f683dcb3338cc24ba7acdd2a09 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["script"]) {
            // line 35
            echo "\t\t\t <script src=\"";
            echo twig_get_attribute($this->env, $this->source, $context["script"], "href", [], "any", false, false, false, 35);
            echo "\" type=\"text/javascript\"></script>
\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t<a href=\"";
            ...
            echo "\">";
            echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 137));
            echo "</a>
\t\t\t\t\t\t</li>
\t\t\t\t\t";
        }
...
";
    ...
    {
        return array (  286 => 140,  275 => 137,  272 => 136,  268 => 135,  172 => 43,  163 => 41,  158 => 40,  147 => 38,  142 => 37,  133 => 35,  128 => 34,  115 => 32,  111 => 31,  107 => 29,  101 => 27,  98 => 26,  92 => 24,  90 => 23,  86 => 22,  82 => 21,  78 => 20,  69 => 13,  66 => 12,  57 => 10,  52 => 9,  40 => 2,  37 => 1,);
    }
