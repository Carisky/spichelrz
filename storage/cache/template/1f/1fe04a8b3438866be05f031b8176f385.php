...
class __TwigTemplate_a1b8a8632e59e036e4c304d7e79e7246 extends Template
{
    private $source;
    private $macros = [];
...
-            });
-        }
    var \$btn = \$('#wholesale-confirm');
    function lockBtn()   { \$btn.prop('disabled', true).addClass('loading'); }
    function unlockBtn() { \$btn.prop('disabled', false).removeClass('loading'); }
    function confirm() {
        \$('[data-error]').removeClass('input-error').find('.form-error').text('').hide();
        lockBtn();
        \$('body').append(loader);
                ...
                if (json.error) {
                    \$.each(json.error, function(i, v){
                        \$('[data-error=\"'+i+'\"]').addClass('input-error')
                                .find('.form-error').text(v).show();
                    });
                    \$('html, body').animate({ scrollTop: \$('#wholesale').offset().top }, 'slow');
                } else if (json.payment) {
                    \$('#payment').html(json.payment);
                    // уже настроенные редиректы нажмут свою кнопку
                    \$('#payment').find('#button-confirm, .js-bluepayment-confirm').click();
                }
                unlockBtn();
            },
            error: function(xhr) {
...
";
    ...
    {
        return array (  509 => 262,  502 => 258,  495 => 254,  488 => 250,  481 => 246,  469 => 237,  458 => 229,  450 => 223,  441 => 219,  427 => 211,  420 => 207,  413 => 205,  408 => 202,  402 => 199,  399 => 198,  393 => 195,  389 => 194,  386 => 193,  384 => 192,  374 => 187,  366 => 182,  355 => 176,  350 => 174,  343 => 170,  337 => 167,  330 => 165,  324 => 164,  318 => 163,  308 => 156,  303 => 154,  298 => 152,  287 => 145,  283 => 144,  263 => 128,  259 => 127,  248 => 121,  235 => 113,  226 => 109,  217 => 105,  210 => 101,  198 => 92,  189 => 88,  180 => 84,  171 => 80,  162 => 76,  153 => 72,  150 => 71,  146 => 69,  140 => 65,  132 => 63,  123 => 62,  119 => 61,  113 => 58,  109 => 56,  107 => 55,  81 => 31,  57 => 9,  53 => 7,  51 => 6,  46 => 4,  42 => 3,  39 => 2,  37 => 1,);
    }
