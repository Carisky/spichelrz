...
class Smtp extends \stdClass {
	...
	public function send() {
		...
		$header .= 'Content-Type: multipart/alternative; boundary="' . $boundary . '"' . PHP_EOL . PHP_EOL;
		...
		// } else {
			...
			// $message .= 'Content-Transfer-Encoding: 8bit' . PHP_EOL . PHP_EOL;
			$message .= ($this->html?$this->html:$this->text) . PHP_EOL . ' ' . PHP_EOL;
			// $message .= '--' . $boundary . '_alt--' . PHP_EOL;
		// }
